<x-master>
  <div class="pt-10 container mx-auto">
    estoy en la vista create para ingresar un Formulario
    <form class="w-full max-w-lg" action="/shoes" method="post">
      @csrf
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <p class="text-red-500 text-xs italic">Pro favor llene este campo.</p>
        </div>
      ...
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <div class="relative">
          <select name="color"
            ...
            <option value="rojo/negro">Rojo/Blanco</option>
      ...
      <button type="submit"
        class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">Enviar</button>
    </form>
  </div>
</x-master>